...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            stdout.write("\r "+Fore.RED+">>>"+Fore.WHITE+" Proses => " + str((until - datetime.datetime.now()).total_seconds()) + " remaining time ")
        else:
            stdout.flush()
            stdout.write("\r"+Fore.RED+">>>"+Fore.WHITE+" FINISHED "+Fore.RED+"<<<                                    \n")
            return
...
def title():
    ...
    stdout.write("                                    \n")
    stdout.write("\n")
    stdout.write(""+Fore.RED   +">>>>>  WELCOME    TO    DDOS-X  <<<<<\n")
    stdout.write("\n")
    stdout.write(""+Fore.GREEN+"Select Method (cfb)  or  (sky)\n")
    stdout.write(""+Fore.RED+">>> MAKE SURE YOU ARE CONNECTED TO THE INTERNET<<<\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.RED+"╔═══"+Fore.RED+"["""+Fore.RED+""+Fore.RED+"DDOS-X"+Fore.RED+"]"+Fore.RED+"\n╚══> "+Fore.WHITE)
    command = input()
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        ...
        stdout.write("\n")
        stdout.write(f"enter this command : python {sys.argv[0]}\n")
        stdout.write("\n")
        sys.exit()
    ua = open('.ua.txt', 'r').read().split('\n')
    ...
    if method == "cfb":
        ...
        stdout.write(Fore.RED+"Method ERROR\nAvailable methods: cfb, sky\n")